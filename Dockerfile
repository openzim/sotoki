...
RUN wget --progress=dot:giga http://tmp.kiwix.org/wheels/libzim-1.0.0.dev4-cp38-cp38-manylinux1_x86_64.whl \
    && wget --progress=dot:giga http://tmp.kiwix.org/wheels/zimscraperlib-1.4.0.dev4-py3-none-any.whl \
