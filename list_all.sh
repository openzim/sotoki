...
curl --silent https://ia800107.us.archive.org/27/items/stackexchange/stackexchange_files.xml | grep "<file" |sed 's/  <file name="\(.*\)\.7z".*$/\1/' |grep -v "stackexchange_" |grep  ".com$"
